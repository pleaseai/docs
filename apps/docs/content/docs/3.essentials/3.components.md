...
**Docus and shadcn-vue** provides a set of styled and beautiful prose components to help you write your documentation using the [MDC syntax](https://content.nuxt.com/docs/files/markdown#mdc-syntax).

::prose-note{to="https://www.shadcn-vue.com/docs/components/accordion"}
This page highlights only the prose components best suited for writing documentation. For the full list of available components, visit the shadcn-vue documentation.
::

### `Accordion`

Use the `accordion` and `accordion-item` components to display an [Accordion](https://www.shadcn-vue.com/docs/components/accordion) in your content.
...
::tabs
  :::tabs-item{icon="i-lucide-eye" label="Preview"}
    ::::accordion
      ...
      ---
      Docus is a fully integrated documentation solution built with shadcn-vue. It's a theme based on the UI documentation template that provides a ready-to-use visual. User can focus on content using Markdown and MDC syntax.
      :::::
      ...
      :::::accordion-item{icon="i-lucide-circle-help" label="What is shadcn-vue?"}
      [shadcn-vue](https://www.shadcn-vue.com/) is a collection of beautifully designed Vue components.
      :::::
    ::::
  :::
  ...
  ::accordion
    ...
    :::accordion-item{label="What is shadcn-vue?" icon="i-lucide-circle-help"}
    [shadcn-vue](https://www.shadcn-vue.com/) is a collection of beautifully designed Vue components.
    :::
  ::
  ```
...
Use markdown in the default slot of the `badge` component to display a [Badge](https://www.shadcn-vue.com/docs/components/badge) in your content.
...
Wrap your content with the `collapsible` component to display a [Collapsible](https://www.shadcn-vue.com/docs/components/collapsible) in your content.
...
Use the `tabs` and `tabs-item` components to display [Tabs](https://www.shadcn-vue.com/docs/components/tabs) in your content.
